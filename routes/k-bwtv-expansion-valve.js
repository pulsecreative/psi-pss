...
var KBWTVExpansionValve = mongoose.model('KBWTVExpansionValve');
...
/* GET Page for KBWTV Expansion Valve Product Selection Software. */
router.get('/', function(req, res, next) {
  res.render('k-bwtv-expansion-valve/search', {});
});
...
router.post('/results', function(req, res, next){
    ...
    .exec(function(err, models) {
      ...
      res.render('k-bwtv-expansion-valve/search-results', query_data);
    });
});
