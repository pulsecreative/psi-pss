...
router.get('/', function(req, res, next) {
  res.render('single-pressure-switch/search', {});
});
...
router.post('/results', function(req, res, next){
    ...
    .exec(function(err, models) {
      ...
      res.render('single-pressure-switch/search-results', query_data);
    });
});
...
router.get('/data-entry', function(req, res, next){
  ...
  .exec(function(err, models) {
    ...
    res.render('single-pressure-switch/data-entry', {models});
  });
});
