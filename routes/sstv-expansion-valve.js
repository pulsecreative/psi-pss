...
var SSTVExpansionValve = mongoose.model('SSTVExpansionValve');
...
/* GET Page for SSATVE SSBTVE Expansion Valve Product Selection Software. */
router.get('/', function(req, res, next) {
  res.render('sstv-expansion-valve/search', {});
});
...
router.post('/results', function(req, res, next){
    ...
    .exec(function(err, models) {
      ...
      res.render('sstv-expansion-valve/search-results', query_data);
    });
});
