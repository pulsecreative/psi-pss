...
var SVGSolenoidValve = mongoose.model('SVGSolenoidValve');
...
/* GET Page for SV-G Series Solenoid Valve Product Selection Software. */
router.get('/', function(req, res, next) {
  res.render('svg-solenoid-valve/search', {});
});
...
router.post('/results', function(req, res, next){
    ...
    .exec(function(err, models) {
      ...
      res.render('svg-solenoid-valve/search-results', query_data);
    });
});
