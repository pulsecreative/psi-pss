...
var KASTVExpansionValve = mongoose.model('KASTVExpansionValve');
...
router.get('/', function(req, res, next) {
  res.render('k-astv-expansion-valve/search', {});
});
...
router.post('/results', function(req, res, next){
    ...
    .exec(function(err, models) {
      ...
      res.render('k-astv-expansion-valve/search-results', query_data);
    });
});
