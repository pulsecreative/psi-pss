...
var ETVExpansionValve = mongoose.model('ETVExpansionValve');
...
/* GET Page for ETV Expansion Valve Product Selection Software. */
router.get('/', function(req, res, next) {
  res.render('etv-expansion-valve/search', {});
});
...
router.post('/results', function(req, res, next){
    ...
    .exec(function(err, models) {
      ...
      res.render('etv-expansion-valve/search-results', query_data);
    });
});
